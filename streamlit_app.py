...
def train_pythae_vae(
    ...
    model = VAE(model_config, encoder=Encoder_VAE_MLP(input_dim=n_features, latent_dim=latent_dim), decoder=Decoder_AE_MLP(input_dim=n_features, latent_dim=latent_dim)).to(device)
